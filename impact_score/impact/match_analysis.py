...
class RoundReplay:
    ...
    def __handle_special_situation(self, input_table: pd.DataFrame, **kwargs):
        """ Fix some probabilities at end of the round situations """
    ...
    def __append_round_events_to_probability_dataframe(self, table: pd.DataFrame) -> None:
        """ Append columns with detailed info about the round events to the probability dataframe """
